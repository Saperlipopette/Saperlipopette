	   ...
	   public static void main(String[] a) {
	        ...
	        new Thread() {
	            public void run() {
	                ...
	                Collection<Tuple> resIntStr = linda.takeAll(motif);
	                Collection<Tuple> resIntInt = linda.takeAll(motif2);
	               
	                System.out.println("(1) Resultat:" + resIntStr);
	                System.out.println("(2) Resultat:" + resIntInt);
	                Tuple resIntStr2 = linda.tryRead(motif);
	                if (resIntStr2==null) {
	                System.out.println("(3) Resultat: TRUE");
	                } else {
		                System.out.println("(3) Resultat: FALSE");
	                }
	                linda.debug("(1)");
	            }
	        }.start();
