...
public class BasicTestOlivierAsyncCallbackReadFuture {
    ...
    public static void main(String[] a) {
        ...
        linda.eventRegister(eventMode.READ, eventTiming.FUTURE, motif, new AsynchronousCallback(new MyCallback()));
        linda.eventRegister(eventMode.READ, eventTiming.FUTURE, motif2, new AsynchronousCallback(new MyCallback()));
        linda.eventRegister(eventMode.READ, eventTiming.FUTURE, motif, new AsynchronousCallback(new MyCallback()));
        linda.eventRegister(eventMode.READ, eventTiming.FUTURE, motif,new AsynchronousCallback(new MyCallback()));
