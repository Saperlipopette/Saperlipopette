...
public class LindaClient implements Linda {
    ...
    public LindaClient(String serverURI) {
    	...
    	try{
			...
			System.out.println("Erreur lors de la cr�ation du client");
			e.printStackTrace();
		}
    }
	...
	public void write(Tuple t) {
		try {
			...
			System.out.println("Erreur lors de l'�criture du Tuple");
			e.printStackTrace();
		}
	}
	...
	public static void main(String[] args) {
			final class MyCallback implements Callback {
				public void call(Tuple t) {
					System.out.println("Je suis un callback et j'ai re�u : "+t);
				}
			}
			final class MyOtherCallback implements Callback {
				public void call(Tuple t) {
					System.out.println("Je suis un autre callback et j'ai re�u : "+t);
				}
			}
