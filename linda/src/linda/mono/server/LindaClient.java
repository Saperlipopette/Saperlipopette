...
public class LindaClient implements Linda {
	...
	public void write(Tuple t) {
		try {
			...
			System.out.println("Erreur lors de l'ï¿½criture du Tuple");
			e.printStackTrace();
		}
	}
	...
	public static void main(String[] args) {
			final class MyCallback implements Callback {
				public void call(Tuple t) {
					System.out.println("Je suis un callback et j'ai reï¿½u : "+t);
				}
			}
			final class MyOtherCallback implements Callback {
				public void call(Tuple t) {
					System.out.println("Je suis un autre callback et j'ai reï¿½u : "+t);
				}
			}
